...
class MarvelAnswerPageOne : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_marvel_answer_page_one)
        ...
        nextButton = findViewById(R.id.marvel_answer_page_one_next)
        nextButton.setOnClickListener {
            val secondQuestion = Intent(this, MarvelQuestionTwo::class.java)
