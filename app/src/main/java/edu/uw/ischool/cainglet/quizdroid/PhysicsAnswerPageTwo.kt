...
class PhysicsAnswerPageTwo : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_physics_answer_page_two)
        ...
        finishButton = findViewById(R.id.physics_answer_page_two_finish)
